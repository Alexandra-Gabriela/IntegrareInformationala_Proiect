...
Raport Final (Analiză Multidimensională):
http://localhost:8081/DSA-SparkSQL-Service/rest/view/OLAP_VIEW_SALES_DEP_CIT_CUST

Locații Clienți (MongoDB + Join):
http://localhost:8081/DSA-SparkSQL-Service/rest/view/VW_CUSTS_LOCATIONS

Fapte de Vânzare (Agregat):
http://localhost:8081/DSA-SparkSQL-Service/rest/view/OLAP_FACTS_SALES_AMOUNT

Structura Tabelului Final (Schema):
http://localhost:8081/DSA-SparkSQL-Service/rest/STRUCT/OLAP_VIEW_SALES_DEP_CIT_CUST

2. Serviciul de Analytics (Aplicația Web)
Acesta rulează pe portul 8096 și expune rezultatele procesate din Spark către Dashboard.

Raport Pareto (Orașe):
http://localhost:8096/DSA-WEB-RESTService/rest/ecommerce-analytics/pareto

Eficiență Logistică:
http://localhost:8096/DSA-WEB-RESTService/rest/ecommerce-analytics/efficiency

Cota de Piață Categorii:
http://localhost:8096/DSA-WEB-RESTService/rest/ecommerce-analytics/market-share

3. Serviciile de Date Brute (Sursele)
PostgreSQL (Produse și Categorii) - Port 8091:
http://localhost:8091/DSA_SQL_JPAService/rest/ecommerce/ProductView

MongoDB (Locații Brazilia) - Port 8093:
